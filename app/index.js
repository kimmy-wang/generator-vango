...
module.exports = class extends Generator {
  ...
  initializing() {
    // Welcome
    this.log(yosay('Welcome to the Vango generator!'))
  }
    ...
    let prompts = {
          ...
          .then(answer => {
            ...
            if (type === 'import-keep' || type === 'import-inline') {
              ...
              return generator
                ...
                .then(urlAnswer => {
                  return themeConverter.convertTheme(
                    urlAnswer.themeURL,
                    generator.extensionConfig,
                    type === 'import-inline',
                    generator,
                  )
                })
      ...
      askForLanguageInfo: () => {
        ...
        return generator
          ...
          .then(urlAnswer => {
            return grammarConverter.convertGrammar(
              urlAnswer.tmLanguageURL,
              generator.extensionConfig,
            )
          })
      },
      ...
      askForLanguageExtensions: () => {
        ...
        return generator
          ...
          .then(extAnswer => {
            generator.extensionConfig.languageExtensions = extAnswer.languageExtensions
              .split(',')
              .map(e => {
                return e.trim()
              })
      ...
      askForPackageManager: () => {
        if (
          ['ext-command-ts', 'ext-command-js', 'ext-localization'].indexOf(
            generator.extensionConfig.type,
          ) === -1
        ) {
          return Promise.resolve()
        }
  ...
  // End
    ...
    this.log('')
    this.log('Your vango project ' + this.extensionConfig.name + ' has been created!')
    this.log('')
